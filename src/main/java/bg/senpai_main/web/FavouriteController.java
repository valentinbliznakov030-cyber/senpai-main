...
public class FavouriteController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> removeFavourite(@AuthenticationPrincipal MemberData memberData, @PathVariable("id") UUID id){
        favoriteService.removeFavourite(memberData.getId(), id);
